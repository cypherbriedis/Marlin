...
#define STRING_CONFIG_H_AUTHOR "(Maris Briedis 21-02-2021 SKRv1.4 Turbo)" // Who made the changes.
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -38, -7, -3.4 }
