...
#define STRING_CONFIG_H_AUTHOR "(Maris Briedis 25-10-2020 SKRv1.4 Turbo)" // Who made the changes.
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -42, -5, -3.4 }
